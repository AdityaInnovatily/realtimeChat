...
export default function Register() {
  ...
  const handleValidation = () => {
    const { password, confirmPassword, username, email, mobile } = values;
  ...
  const handleSubmit = async (event) => {
    ...
    if (handleValidation()) {
      const { email, username, password,mobile } = values;
      console.log("values;",values, localStorageUserDetails);
